...
public class XphonenumberActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.xphonenumber);
	...
	private void initializeLogic() {
		...
		try{
			...
			list = new Gson().fromJson(RizwanUtil.copyFromInputStream(inputstream1), new TypeToken<ArrayList<HashMap<String, Object>>>(){}.getType());
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			textview1.setText(list.get((int) _position).get("thana").toString());
			linear1.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View _view) {
					in.setClass(getApplicationContext(), AllphonenumberActivity.class);
					in.putExtra("heading", list.get((int) _position).get("thana").toString());
					startActivity(in);
				}
			});
